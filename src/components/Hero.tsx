...
const Hero = () => {
	return (
		<div className="mx-auto mt-20 max-w-[36rem] px-8 sm:md:lg:px-0">
			...
			<div className="flex items-center mt-10 gap-4">
				<a href="https://github.com/theotheobeats" className="flex-shrink-0" target="_blank">
				...
				<a
					...
					className="flex-shrink-0" target="_blank">
				...
				<a
					href="/resume"
					className="flex bg-secondary rounded-lg px-2 hover:opacity-70 transition-all" target="_blank">
